...
describe('selectTeamsAround', () => {
  ...
  test('should return slice of odd count from the middle', () => {
  ...
  test('should return slice of even count from the middle', () => {
  ...
  test('should return slice from the beginning', () => {
  ...
  test('should return slice from the end', () => {
